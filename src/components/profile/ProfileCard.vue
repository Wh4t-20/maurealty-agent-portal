      ...
      <div class="mt-5 grid grid-cols-3 gap-5">
        <div class="col-span-full">
          <label class="text-maurealty-blue dark:text-white font-medium text-sm block">Last Name, First Name, Middle Name</label>
            ...
            <p class="w-auto dark:text-maurealty-light-blue font-medium text-lg tracking-wider uppercase">
              {{ props.agent.last_name }}, {{ props.agent.first_name }} {{ props.agent.middle_name || '' }}
            </p>
            <img
              v-if="props.agent.admin_access"
              :src="configs.darkThemeEnabled ? MauBadgeLight : MauBadgeDark" 
        ...
        <div>
          <label class="text-maurealty-blue dark:text-white font-medium text-sm block">Sex</label>
          <p class="w-full dark:text-maurealty-light-blue font-medium text-base tracking-wider uppercase">
            {{ props.agent.sex }}
          </p>
        </div>

        <div>
          <label class="text-maurealty-blue dark:text-white font-medium text-sm block">Age</label>
          <p class="w-full dark:text-maurealty-light-blue font-medium text-base tracking-wider">
            {{ getAge(props.agent.birth_date) }}
          </p>
        </div>

        <div>
          <label class="text-maurealty-blue dark:text-white font-medium text-sm block">Date of Birth</label>
          <p class="w-full dark:text-maurealty-light-blue font-medium text-base tracking-wider uppercase">
        ...
        <div class="col-span-full">
          <label class="text-maurealty-blue dark:text-white font-medium text-sm block">Address</label>
          <p class="w-full dark:text-maurealty-light-blue font-normal text-base tracking-wider uppercase">
            {{ props.agent.home_address }}
          </p>
        </div>

        <div>
          <label class="text-maurealty-blue dark:text-white font-medium text-sm block">Contact No.</label>
          <p class="w-full dark:text-maurealty-light-blue font-normal text-base tracking-wider uppercase">
        ...
        <div>
          <label class="text-maurealty-blue dark:text-white font-medium text-sm block">Agent ID</label>
          <p class="w-full dark:text-maurealty-light-blue font-medium text-base tracking-wider uppercase">
        ...
        <div>
          <label class="text-maurealty-blue dark:text-white font-medium text-sm block">Position</label>
          <p class="w-full dark:text-maurealty-light-blue font-medium text-base tracking-wider uppercase">
        ...
        <div>
          <label class="text-maurealty-blue dark:text-white font-medium text-sm block">Hire Date</label>
          <p class="w-full dark:text-maurealty-light-blue font-normal text-base tracking-wider uppercase">
